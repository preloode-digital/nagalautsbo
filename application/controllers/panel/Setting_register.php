...
class Setting_register extends CI_Controller {
	...
	private function load() {
		...
		$this->load->view('panel/setting_register', $data);
	...
	private function loadPage() {
		...
		$this->initialize['page']['register']['data'] = $this->page_data->loadBindName($load);
