...
class Setting_about_us extends CI_Controller {
	...
	private function load() {
		...
		$this->load->view('panel/setting_about_us', $data);
	...
	private function loadPage() {
		...
		$this->initialize['page']['aboutUs']['data'] = $this->page_data->loadBindName($load);
