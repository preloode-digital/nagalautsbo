...
class Setting_withdrawal extends CI_Controller {
	...
	private function load() {
		...
		$this->load->view('panel/setting_withdrawal', $data);
	...
	private function loadPage() {
		...
		$this->initialize['page']['withdrawal']['data'] = $this->page_data->loadBindName($load);
