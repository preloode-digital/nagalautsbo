...
class Setting_live_score extends CI_Controller {
	...
	private function load() {
		...
		$this->load->view('panel/setting_live_score', $data);
	...
	private function loadPage() {
		...
		$this->initialize['page']['liveScore']['data'] = $this->page_data->loadBindName($load);
