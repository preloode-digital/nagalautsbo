...
class Transaction_saving_data extends CI_Model {
	...
	public function delete($data) {
		...
		$sql = 'DELETE FROM transaction_saving WHERE id = ?';
		$bind = array(
			$data['id']
		);
	...
	public function insert($data) {
		...
		$sql = 'INSERT INTO transaction_saving SET';
		$bind = array();
	...
	public function loadBindId($data) {
		...
		$sql = 'SELECT * FROM transaction_saving WHERE id = ?';
		$bind = array(
			$data['id']
		);
	...
	public function loadPagination($data) {
		...
		$sql = 'SELECT * FROM transaction_saving';
	...
	public function update($data) {
		...
		$sql = 'UPDATE transaction_saving SET';
		$bind = array();
