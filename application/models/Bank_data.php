...
class Bank_data extends CI_Model {
	...
	public function loadBindName($data) {
		...
		$sql = 'SELECT * FROM bank WHERE name = ?';
		$bind = array(
			$data['name']
		);
		$query = $this->db->query($sql, $bind);
	...
	public function loadBindStatusOrderNameAsc($data) {
		...
		$sql = 'SELECT * FROM bank WHERE status = ? ORDER BY name ASC';
		$bind = array(
			$data['status']
		);
		$query = $this->db->query($sql, $bind);
	...
	public function loadOrderNameAsc() {
		...
		$sql = 'SELECT * FROM bank ORDER BY name ASC';
