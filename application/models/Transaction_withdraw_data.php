...
class Transaction_withdraw_data extends CI_Model {
	...
	public function delete($data) {
		...
		$sql = 'DELETE FROM transaction_withdraw WHERE id = ?';
		$bind = array(
			$data['id']
		);
	...
	public function insert($data) {
		...
		$sql = 'INSERT INTO transaction_withdraw SET';
		$bind = array();
	...
	public function loadBindId($data) {
		...
		$sql = 'SELECT * FROM transaction_withdraw WHERE id = ?';
		$bind = array(
			$data['id']
		);
	...
	public function update($data) {
		...
		$sql = 'UPDATE transaction_withdraw SET';
		$bind = array();
