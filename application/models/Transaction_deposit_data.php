...
class Transaction_deposit_data extends CI_Model {
	...
	public function delete($data) {
		...
		$sql = 'DELETE FROM transaction_deposit WHERE id = ?';
		$bind = array(
			$data['id']
		);
	...
	public function insert($data) {
		...
		$sql = 'INSERT INTO transaction_deposit SET';
		$bind = array();
	...
	public function loadBindId($data) {
		...
		$sql = 'SELECT * FROM transaction_deposit WHERE id = ?';
		$bind = array(
			$data['id']
		);
	...
	public function loadPagination($data) {
		...
		$sql = 'SELECT * FROM transaction_deposit';
	...
	public function update($data) {
		...
		$sql = 'UPDATE transaction_deposit SET';
		$bind = array();
