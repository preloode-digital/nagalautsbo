...
class Transaction_expense_data extends CI_Model {
	...
	public function delete($data) {
		...
		$sql = 'DELETE FROM transaction_expense WHERE id = ?';
		$bind = array(
			$data['id']
		);
	...
	public function insert($data) {
		...
		$sql = 'INSERT INTO transaction_expense SET';
		$bind = array();
	...
	public function loadBindId($data) {
		...
		$sql = 'SELECT * FROM transaction_expense WHERE id = ?';
		$bind = array(
			$data['id']
		);
	...
	public function loadPagination($data) {
		...
		$sql = 'SELECT * FROM transaction_expense';
	...
	public function update($data) {
		...
		$sql = 'UPDATE transaction_expense SET';
		$bind = array();
