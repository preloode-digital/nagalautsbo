...
if(!empty($data['css'])) {
	...
	for ($i = 0; $i < count($data['css']); $i++) {
		...
		$view['css'] .= '<link rel="stylesheet" type="text/css" href="'.base_url().'asset/css/'.$data['css'][$i].'.css">'."\n";
...
if(!empty($data['javascript'])) {
	...
	for ($i = 0; $i < count($data['javascript']); $i++) {
		...
		$view['javascript'] .= '<script type="text/javascript" src="'.base_url().'asset/javascript/'.$data['javascript'][$i].'.js"></script>'."\n";
...
<link rel="icon" type="image/x-icon" href="<?php echo base_url() ?>asset/image/favicon.ico">
...
<!--<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>asset/css/jquery_animateslider.css">-->
<!--<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>asset/css/normalize.css">-->
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>asset/css/owl_carousel.css">
<link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>asset/css/owl_theme_default.css">
...
<!--<script type="text/javascript" src="<?php echo base_url() ?>asset/javascript/numeral.js"></script>-->
...
<!--<script type="text/javascript" src="<?php echo base_url() ?>asset/javascript/modernizr.js"></script>-->
<!--<script type="text/javascript" src="<?php echo base_url() ?>asset/javascript/jquery_animateslider.js"></script>-->
<script type="text/javascript" src="<?php echo base_url() ?>asset/javascript/owl_carousel.js"></script>
<!--<script type="text/javascript" src="https://www.google.com/recaptcha/api.js"></script>-->
<script type="text/javascript" src="<?php echo base_url() ?>asset/javascript/global.js"></script>
<?php echo $view['javascript'] ?>
</head>

<body>
<div id="config" data-base-url="<?php echo base_url() ?>"></div>
<div id="loading">
	<div class="wrapper">
...
<div id="popup">
	<div class="wrapper">
    	<div class="close">
        	<i class="remove-20-white close-popup"></i>
        </div>
