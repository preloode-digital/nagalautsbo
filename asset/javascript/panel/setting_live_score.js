$(document).ready(function() {
	...
	function settingLiveScore() {
		...
		this.updateLiveScore = function() {
			...
			$.ajax({
				...
				'dataType' : 'json',
				'method' : 'POST',
				'url' : this.initialize.panelUrl+'setting_live_score_ajax/'
	...
	var settingLiveScore = new settingLiveScore();
		
	CKEDITOR.replace('ckeditor');
	
	$('button.update').click(function() {
		
		settingLiveScore.updateLiveScore();
