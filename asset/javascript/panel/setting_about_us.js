$(document).ready(function() {
	...
	function settingAboutUs() {
		...
		this.updateAboutUs = function() {
			...
			$.ajax({
				...
				'dataType' : 'json',
				'method' : 'POST',
				'url' : this.initialize.panelUrl+'setting_about_us_ajax/'
	...
	var settingAboutUs = new settingAboutUs();
		
	CKEDITOR.replace('ckeditor');
	
	$('button.update').click(function() {
		
		settingAboutUs.updateAboutUs();
