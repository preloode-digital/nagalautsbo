$(document).ready(function() {
	...
	function settingWithdrawal() {
		...
		this.updateWithdrawal = function() {
			...
			$.ajax({
				...
				'dataType' : 'json',
				'method' : 'POST',
				'url' : this.initialize.panelUrl+'setting_withdrawal_ajax/'
	...
	var settingWithdrawal = new settingWithdrawal();
		
	CKEDITOR.replace('ckeditor');
	
	$('button.update').click(function() {
		
		settingWithdrawal.updateWithdrawal();
